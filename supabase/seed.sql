...
values
  ('AR10ET',  'Air Rifle 10 m',                  'rifle',  10, 'standing', 10, 'decimal', 10.9, false),
  ('AP10ET',  'Air Pistol 10 m',                 'pistol', 10, 'standing', 10, 'integer', 10.0, true),
  ('SBR10ET', 'Smallbore Rifle 50 m prone',      'rifle',  50, 'prone',    10, 'decimal', 10.9, false),
  ('SBP10ET', 'Sport Pistol 25 m',               'pistol', 25, 'standing', 10, 'integer', 10.0, true)
